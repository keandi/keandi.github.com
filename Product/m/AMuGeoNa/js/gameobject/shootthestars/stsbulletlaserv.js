class STSBulletLaserV extends STSBaseBullet {
    ...
    destroy() {
        ...
        let v = this.#_PV;
        destroyObjects( v.collisionTimer );
        v.collisionTimer = undefined;
    }
    ...
    get H() {
        try {
            ...
            const canonHeight = v.frameData.frames.get('LASER1_0000').sourceSize.h;
    ...
    run(x, y) {
        try {
            ...
            v.collisionTimer.startInterval(()=>checkCollision(), fps(60));
