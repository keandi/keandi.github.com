...
BaseScene.prototype.loadAssets = function() {
    ...
    else
    {
        ...
        /* _wgl_serialLoadHistory 을 사용하기 위해 막는다.
...
BaseScene.prototype.startSerialLoadAssets = function() {
    ...
    if (_wgl_serialLoadHistory.isLoadedAsset(loader.name) == true)
    {
    ...
    else
    {
        ...
        loader.cb();
        _wgl_serialLoadHistory.ReservedKey = loader.name;
        this.load.start();
    }
}
...
BaseScene.prototype.onCompleteSerialLoadAsset = function(isAllFinished)
{
    ...
    _wgl_serialLoadHistory.addReservedKey();
